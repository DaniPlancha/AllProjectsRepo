    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AirportDbContext>(options => {
                options.UseMySql("server=localhost; port=3310; user=root; password=DaniGotiniq1234; database=airports_project_final_DB", new MySqlServerVersion(new System.Version(8, 0, 22)));
            });
